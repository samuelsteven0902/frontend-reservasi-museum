    ...
    <>
        <footer className="relative bg-gray-100 pt-8 h-[25rem] w-full">
            <div className=" m-auto w-full h-full bg-cover bg-center absolute bottom-0 bg-no-repeat  bg-clip-content bg bg-landing-bawah">
                <div className=" flex flex-wrap flex-row-reverse text-center lg:text-left pt-6 bg-gray- h-full"  style={sectionStyle}>
                    ...
                    <div className='w-1/2 m-auto'>
                        <ul className='text-center text-black'>
                            <li className='py-2 text-2xl font-bold'>Museum Radya Pustaka</li>
                            <li className='py-3 font-semibold'>Alamat: Jl. Slamet Riyadi No 275,<br></br> Kec. Laweyan, Kota Surakarta,<br></br> Jawa Tengah 57141</li>
                            <li className='flex justify-center items-center font-semibold'><GrInstagram /> <p className='pl-3'>museumradyapustaka</p></li>
                            <li className='flex justify-center items-center'><TbWorld /><p className='pl-3 font-semibold'>radyapustaka.id</p></li>
                        </ul>
                    </div>
