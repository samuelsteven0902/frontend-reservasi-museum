...
<>
      ...
      <div className='flex justify-center'>
          <button class=" mb-10 bg-[#A70B0B] hover:bg-[#A70B0B]  text-white font-bold py-4 px-8 rounded-full focus:outline-none focus:shadow-outline" onClick={handleCaptureClick}>
            Download
          </button>
        </div>
      ...
      <div className='bg-[#A70B0B] w-96   text-white rounded-3xl '>
        <div className='p-6'>
          ...
          <p className='text-center text-3xl py-2 font-serif '>TIKET RESERVASI</p>
        </div>
        </div>
        <div className='bg-[#A70B0B] w-96 mx-auto text-white rounded-3xl'>
          ...
          <div className='grid grid-cols-2 gap-8 w-full mx-auto justify-center pl-5 text-lg'>
            ...
            <div>
              <p className='text-base'>Tanggal Kunjungan</p>
              <p className='font-semibold text-xl font-nunito'>{tiket.tanggal}</p>
            </div>
            <div>
              <p>Keterangan Tiket</p>
              <p className='font-semibold text-xl font-nunito'>{tiket.status}</p>
            </div>
          </div>
          </div>
        </div>
        {/* <div className='bg-[#A70B0B] w-96 mx-auto py-6 text-white rounded-3xl'>
          <p className='flex justify-center pb-4  text-3xl'>Scan Barcode</p>
