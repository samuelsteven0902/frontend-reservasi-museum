...
{/* <h1>Loading..</h1> */}
      ...
      {
        var ctxPengunjungBulanan = document.getElementById("line-chart-bulanan").getContext("2d");
        window.myLine = new Chart(ctxPengunjungBulanan,configPengunjungBulanan);
        // window.myLine = new Chart(ctxPengunjungBulanan).Line(configPengunjungBulanan,{
        //   responsive:true
        // });
        
        var ctxPengunjungTahunan = document.getElementById("line-chart-tahunan").getContext("2d");
      // console.log(dataPengunjungJan);
      window.myLine = new Chart(ctxPengunjungTahunan,configPengunjungTahunan);
      // window.myLine = new Chart(ctxPengunjungTahunan).Line(configPengunjungTahunan,{
      //   responsive:true
      // });
