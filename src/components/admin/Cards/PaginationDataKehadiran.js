...
function Items(props) {
  const dataKehadiran = props.data
  console.log(props);
...
function PaginationDataKehadiran(props) {
  ...
  const dataKehadiran = Object.entries(props);
  ...
  const pageCount = Math.ceil(dataKehadiran[0][1].length / itemsPerPage);
...
export default PaginationDataKehadiran;