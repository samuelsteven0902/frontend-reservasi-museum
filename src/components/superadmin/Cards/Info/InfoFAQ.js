    ...
    faq_HTMLTABLE = dataFAQ.map((item,index)=>{
        return(
            <tr className='' key={index}>
                <th scope="col" class="text-xl font-medium text-[#A70B0B] px-6 py-4 text-left ">{index + 1}</th>
                <th scope="col" class="text-xl font-medium text-[#A70B0B] px-6 py-4 text-left">
                    ...
                    <td class=" text-gray-900 px-6 py-4 whitespace-nowrap ">
                        <button type="button" className="inline-block px-6 py-2.5 mx-5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-bs-toggle="modal" id={item.id} data-bs-target="#exampleModalCenteredScrollable" onClick={handleIdFAQ}>Edit</button>
...
return (
    ...
    <div className='justify-between'>
        <div class="flex space-x-2 justify-between">
            <h3 class="font-bold text-5xl text-gray-600">Frequently Asked Questions</h3>
