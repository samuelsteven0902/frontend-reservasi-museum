...
function InfoPanduan() {
  ...
  <div className='justify-between'>
    <div class="flex space-x-2 justify-between">
      <h3 class="font-bold text-5xl text-gray-600">Panduan</h3>
              ...
              <div class="overflow-hidden shadow-lg rounded-xl m-2">
                <table class="min-w-full ">
                  <thead class="border-b bg-white ">
                    <tr className=''>
                      <p scope="col" class="text-xl font-medium text-[#A70B0B] px-6 py-4 text-left ">1. Lorem Ipsum is simply dummy text of the printing</p>
                    </tr>
                  </thead>
                </table>
              </div>
