    ...
    <div className='  '>
        <div className='relative container mx-auto py-5 pb-20'>
            ...
            <div className='sm:flex block justify-center pt-16 w-full'>
                ...
                <Link to='/panduan' className='text-center w-72 border-0 transition-all duration-200 ease-in-out rounded-2xl hover:bg-none sm:hover:bg-[#ECE3DE] p-7' data-aos="fade-up"
     data-aos-delay="150" aos-duration="1000"> 
                ...
                <Link to='/faq' className='text-center w-72 border-0 transition-all duration-200 ease-in-out mx-12 rounded-2xl hover:bg-none sm:hover:bg-[#ECE3DE] p-7' data-aos="fade-up"
     data-aos-delay="300" aos-duration="1000"> 
                ...
                <Link to='/harga-tiket' className='text-center w-72 border-0 transition-all duration-200 ease-in-out  rounded-2xl hover:bg-none sm:hover:bg-[#ECE3DE] p-7' data-aos="fade-up" 
     data-aos-delay="450" aos-duration="1000"> 
